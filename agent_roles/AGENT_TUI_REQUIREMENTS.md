...
> You own the terminal user interface — everything the user sees and interacts with in the terminal. This includes the dashboard render loop, all Ink components, keyboard input handling, and the CLI entry point. You do not implement business logic — you call State, Orchestrator, and Queue APIs.
